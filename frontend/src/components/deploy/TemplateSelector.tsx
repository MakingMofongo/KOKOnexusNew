...
const industryTemplates = [
  {
    ...
    subtypes: [
      { id: 'hotel-boutique', name: 'Boutique Hotel', description: 'Personalized, luxury experience focus' },
      { id: 'hotel-business', name: 'Business Hotel', description: 'Efficient, professional service' },
      { id: 'hotel-resort', name: 'Resort', description: 'Vacation and leisure focused' }
    ]
  },
  {
    id: 'healthcare',
    ...
    subtypes: [
      { id: 'healthcare-clinic', name: 'Medical Clinic', description: 'General practice and appointments' },
      { id: 'healthcare-specialist', name: 'Specialist Office', description: 'Specialized medical services' },
      { id: 'healthcare-dental', name: 'Dental Practice', description: 'Dental services focus' }
    ]
  },
  {
    id: 'retail',
    ...
    subtypes: [
      { id: 'retail-boutique', name: 'Boutique Store', description: 'Personalized, luxury experience focus' },
      { id: 'retail-business', name: 'Business Store', description: 'Efficient, professional service' },
      { id: 'retail-resort', name: 'Resort', description: 'Vacation and leisure focused' }
    ]
  },
  {
    id: 'education',
    ...
    subtypes: [
      { id: 'education-elementary', name: 'Elementary School', description: 'Primary education' },
      { id: 'education-highschool', name: 'High School', description: 'Secondary education' },
      { id: 'education-university', name: 'University', description: 'Higher education' }
    ]
  },
  {
    id: 'corporate',
    ...
    subtypes: [
      { id: 'corporate-executive', name: 'Executive Office', description: 'High-level management and decision-making' },
      { id: 'corporate-midlevel', name: 'Mid-Level Office', description: 'Intermediate management and decision-making' },
      { id: 'corporate-entrylevel', name: 'Entry-Level Office', description: 'Junior-level tasks and responsibilities' }
    ]
  },
  {
    id: 'professional',
    ...
    subtypes: [
      { id: 'professional-law', name: 'Law Firm', description: 'Legal services focus' },
      { id: 'professional-consulting', name: 'Consulting Firm', description: 'Consulting services focus' },
      { id: 'professional-accounting', name: 'Accounting Firm', description: 'Accounting services focus' }
    ]
  },
]
            ...
            {industryTemplates
              ...
              ?.subtypes.map((subtype) => (
                <motion.button
                  ...
                  onClick={() => handleSelectTemplate(selectedMainType, subtype.id)}
                >
